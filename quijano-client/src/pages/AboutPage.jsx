...
import ReyPic from '../assets/ReyPic.JPG';
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div className="rounded-3xl border-2 border-dashed border-zinc-300 bg-zinc-100 p-6">
            <div className="flex h-72 items-center justify-center rounded-[1.25rem] bg-zinc-200 p-3 sm:h-80">
              <img
                src={ReyPic}
                alt="Reynald Quijano"
                className="h-full w-auto max-w-full rounded-2xl border-2 border-zinc-300 object-contain bg-zinc-50"
              />
            </div>
          </div>
